...
- [Monero.com wallet](https://github.com/cake-tech/cake_wallet/releases): Monero.com wallet created by the CakeWallet team. An open source monero only wallet with support for Tor nodes, multiple wallet support, and uses swap service trocador.app.
